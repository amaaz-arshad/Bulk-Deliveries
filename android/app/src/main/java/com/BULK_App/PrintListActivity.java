...
public class PrintListActivity extends Activity {
    ...
    public static boolean BACK_PRESSED_ONLY = false;
    ...
    private Button buttonscan, btn_receipt;
...
//        LocalBroadcastManager.getInstance(PrintListActivity.this).registerReceiver(mMessageReceiver,
//                new IntentFilter("print"));
    }
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(PrintListActivity.this, "PrintListActivity", Toast.LENGTH_SHORT).show();
            Log.d("PrintListActivity: ", intent.getDataString() + "");
    ...
    public synchronized void onResume() {
        ...
        if (BACK_PRESSED_ONLY){
            BACK_PRESSED_ONLY=false;
            finish();
        }
    }
    ...
    public void printReceipt() {
        ...
        String vs = getIntent().getStringExtra("viePressStart");
        Log.e("viePressStart: ", vs);
        ...
        try {
            ...
            ProgressDialog pd = new ProgressDialog(PrintListActivity.this);
    ...
    public void print1DBarcode(View v) throws IOException {
        ...
        byteStream.write(title1.getBytes());
        byteStream.write(UPCA);
        byteStream.write(cmd_print);
        byteStream.write(title2.getBytes());
        byteStream.write(UPCE);
        byteStream.write(cmd_print);
        byteStream.write(title3.getBytes());
        byteStream.write(EAN13);
        byteStream.write(cmd_print);
        byteStream.write(title4.getBytes());
        byteStream.write(EAN8);
        byteStream.write(cmd_print);
        byteStream.write(title5.getBytes());
        byteStream.write(CODE39);
        byteStream.write(cmd_print);
        byteStream.write(title6.getBytes());
        byteStream.write(ITF);
        byteStream.write(cmd_print);
        byteStream.write(title7.getBytes());
        byteStream.write(CODEBAR);
        byteStream.write(cmd_print);
        byteStream.write(title8.getBytes());
        byteStream.write(CODE93);
        byteStream.write(cmd_print);
        byteStream.write(title9.getBytes());
    ...
    public void print2DBarcode(View v) throws IOException {
        ...
        ByteArrayOutputStream byteStream = new ByteArrayOutputStream(512);
        byteStream.write(title1.getBytes());
        byteStream.write(PDF417);
        byteStream.write(cmd_print);
        byteStream.write(title2.getBytes());
        byteStream.write(dataMatrix);
        byteStream.write(cmd_print);
        byteStream.write(title3.getBytes());
        byteStream.write(QRCode);
        byteStream.write(cmd_print);
        byteStream.write(title4.getBytes());
        byteStream.write(microPDF417);
        byteStream.write(cmd_print);
        byteStream.write(title5.getBytes());
        byteStream.write(truncPDF417);
        byteStream.write(cmd_print);
        byteStream.write(title6.getBytes());
        byteStream.write(maxCode);
        byteStream.write(cmd_print);
    ...
    public void printGS1Databar(View v) throws IOException {
        ...
        ByteArrayOutputStream byteStream = new ByteArrayOutputStream(512);
        byteStream.write(title0.getBytes());
        byteStream.write(gs0);
        byteStream.write(cmd_print);
        byteStream.write(title1.getBytes());
        byteStream.write(gs1);
        byteStream.write(cmd_print);
        byteStream.write(title2.getBytes());
        byteStream.write(gs2);
        byteStream.write(cmd_print);
        byteStream.write(title3.getBytes());
        byteStream.write(gs3);
        byteStream.write(cmd_print);
        byteStream.write(title4.getBytes());
        byteStream.write(gs4);
        byteStream.write(cmd_print);
        byteStream.write(title5.getBytes());
        byteStream.write(gs5);
        byteStream.write(cmd_print);
        byteStream.write(title6.getBytes());
        byteStream.write(gs6);
        byteStream.write(cmd_print);
