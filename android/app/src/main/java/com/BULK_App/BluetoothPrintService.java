...
import com.bulk2.app.PrintListActivity;
...
class BluetoothPrintService {
    ...
    private synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(PrintListActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(PrintListActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(PrintListActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(PrintListActivity.TOAST, R.string.connect_fail);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(PrintListActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(PrintListActivity.TOAST, R.string.connect_lost);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(PrintListActivity.MESSAGE_READ, bytes, -1, rcvData).sendToTarget();
                } catch (IOException e) {
