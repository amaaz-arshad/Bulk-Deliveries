...
export function DrawerContent(props) {
    ...
    return (
        ...
        <DrawerContentScrollView {...props} contentContainerStyle={{ paddingTop: 0, marginTop: 0, flex: 1 }}>

            <View style={styles.drawerContent}>
                <ImageBackground source={require('../../assets/menubg.png')} style={styles.image}>
                    <View style={styles.userInfoSection}>

                        <View style={{
                            height: 100, width: 100, borderColor: 'white',
                            borderWidth: 2, borderRadius: 100, padding: 2, alignItems: 'center'
                        }}>
