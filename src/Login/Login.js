    ...
    axios
      ...
      .then(response => {
        if (response.data.ResultCode == 'S') {
          ...
          {
            this.props.navigation.replace('DrawerComp', {
    ...
    return (
      <View style={styles.container}>
        <KeyboardAwareScrollView>
          ...
          <Image
            source={require('../assets/logo_design.jpg')}
            style={{
              alignItems: 'center',
              width: 100,
              height: 100,
          ...
          <View style={styles.viewStyle}>
            ...
            <Text style={styles.textStyle} style={{fontSize: 30}}>
              Your Account
            </Text>
          </View>
          ...
          <View style={styles.loginEditextSection}>
            ...
            <TextInput
              ...
              onChangeText={this.onChangeUserid}></TextInput>
            ...
            <TextInput
              ...
              onChangeText={this.onChangePassword}></TextInput>
          </View>
        ...
        <View style={styles.bottomText}>
          <Text
            ...
            Powered by Pakistan Oxygen Limited
          </Text>
        </View>
      </View>
    );
