...
export default class TDLSFormDecentre extends Component {
  ...
  submitForm(isBackPressed) {
    ...
    setTimeout(() => {
      ...
      if (isBackPressed) tripStatus = this.state.response.Trip_Status;
      else tripStatus = 5;
            ...
            <TouchableOpacity
              onPress={() => {
                if (
                  ...
                  if (!this.state.hideSubmitBtn) this.backPressDialog();
