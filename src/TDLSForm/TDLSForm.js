...
import { StyleSheet, View, Text, TouchableOpacity, Image, TextInput, StatusBar, ToastAndroid, Platform, Alert, PermissionsAndroid } from 'react-native';
...
export default class TDLSForm extends Component {
    ...
    print() {
        ...
        let timein =
            this.state.response.Trip_Status == 1 || this.state.response.Trip_Status == 3
                ? this.state.Date_In + '\n'
        ...
        let deliveredvolume =
            ...
            ' M3' +
            '\n';
        let comments = this.state.Additional_Remarks ? this.state.Additional_Remarks : '' + '\n';
        ...
        console.log('CalculationBaseType id: ', this.props.route.params.userData.CalculationBaseTypeID)
    ...
    validate() {
        ...
        if (this.state.Trip_Status == 5) {
            ToastAndroid.show("Please approve or reject the form", ToastAndroid.SHORT)
            return ""
        }
            ...
            <View>
                ...
                <View style={{ flexDirection: 'column' }}>
                    ...
                    <View style={{ flexDirection: 'row', backgroundColor: 'white', height: 50, alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        >
                            <Image source={require('../assets/print.png')} style={{ width: 20, height: 20, marginEnd: 15 }}></Image>
                        </TouchableOpacity>
                    </View>
                ...
                <KeyboardAwareScrollView>
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.loginEditextSection}>
                            <View pointerEvents={this.props.route.params.userData.Trip_Status == 5 ? undefined : "none"}>
                                ...
                                <TextInput editable={false} style={styles.prefilledEditText} placeholderTextColor={colors.black} placeholder="Customer Code">{this.state.response.CustomerNo}</TextInput>
                                ...
                                <TextInput editable={false} style={styles.prefilledEditText} placeholderTextColor={colors.black} placeholder="Product Code">{this.state.response.PrimaryProduct}</TextInput>
                                ...
                                <TextInput editable={false} style={styles.prefilledEditText} placeholderTextColor={colors.black} placeholder="Vehicle Number">{this.state.response.vehicleno}</TextInput>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={styles.twoInputFieldsStyle}>
                                        ...
                                        <TextInput keyboardType='numeric' input={Float32Array}
                                            editable={this.props.route.params.userData.Trip_Status == 5 ? true : false}
                                            style={this.props.route.params.userData.Trip_Status == 5 ? styles.editText : styles.prefilledEditText}
                                ...
                                <RadioButtonRN
                                    ...
                                    initial={this.props.route.params.userData.CalculationBaseTypeID}
                                    box={false}
                            ...
                            <View style={{
                                ...
                                <SectionedMultiSelect
                                    ...
                                    confirmText={this.state.response.Trip_Status == 5 ? "Confirm" : "Close"}
                                    showChips={false}
                                    hideSearch={true}
                            ...
                            <View
                                ...
                                <TextInput multiline={true} placeholderTextColor={colors.grey}
                                    ...
                                    placeholder="Additional Remarks" style={{ color: 'black', height: 70, textAlignVertical: 'top' }}
                                    onChangeText={text => this.setState({ Additional_Remarks: text })}>{this.state.Additional_Remarks}</TextInput>
                            </View>
                        ...
                        <View style={[styles.dropDownViewStyle, { marginEnd: 15 }]} pointerEvents={this.props.route.params.userData.Trip_Status == 5 ? undefined : "none"}>
                            <Dropdown
                                icon={require('../assets/dropicon.png')}
                                baseColor={'#fff'}
                                iconColor={colors.grey}
                                placeholder={(this.state.Trip_StatusDec == "Approved" || this.props.route.params.userData.Trip_StatusDec == "Closed") ? this.props.route.params.userData.Trip_StatusDec : 'Approved/Rejected'}
                                data={data}
                                style={this.props.route.params.userData.Trip_Status == 5 ? styles.dropDownStyle : styles.dropDownStylePrefilled}
                        ...
                        <View
                            ...
                            style={this.props.route.params.userData.Trip_Status == 5 ?
                                {
                                    flex: 1, borderWidth: 0.5, borderColor: colors.grey,
                                    height: 120, marginTop: 15, marginEnd: 15,
                                ...
                                :
                                {
                                    flex: 1, borderWidth: 0.5, borderColor: colors.grey,
                                    height: 120, marginTop: 15, marginEnd: 15,
                                    paddingStart: 10, paddingEnd: 10, backgroundColor: colors.lightgrey
                                }
                            } >
                            <TextInput multiline={true} placeholderTextColor={colors.greys}
                                editable={this.props.route.params.userData.Trip_Status == 5 ? true : false}

                                placeholder="Reason" style={{ color: 'black', height: 120, textAlignVertical: 'top' }}
                                onChangeText={text => this.setState({ Trip_Reason: text })}>{this.state.Trip_Reason}</TextInput>
                        </View>
                        ...
                        {this.state.hideSubmitBtn == true ? <View style={{ marginBottom: 70 }}></View> :
                            <TouchableOpacity
                                disabled={this.props.route.params.userData.Trip_Status == 5 ? false : true}
                                onPress={() => {
                                    this.submitDialog()
                                }}
                                style={[styles.buttonStyle, { marginBottom: 70, opacity: this.props.route.params.userData.Trip_Status == 5 ? 100 : 0 }]}>
                ...
                >
                    <View
                        ...
                        <Text style={{ fontSize: 20, fontWeight: 'bold', alignSelf: 'center', marginTop: 10, marginBottom: 10 }}>Bluetooth Devices</Text>
            ...
            <View style={{ flexDirection: 'column' }}>
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            style={this.props.route.params.userData.Trip_Status == 5 ? styles.editTextDATA : styles.prefilledEditTextDATA}
                            placeholderTextColor={colors.black}
                        ...
                        <View style={{
                            ...
                            <Dropdown
                                ...
                                data={pressureUnits}
                                underlineColor='transparent'
                                onChangeText={unit => this.setState({ Vie_Press_Start_Unit: unit, Vie_Press_End_Unit: unit })}
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            ...
                            value={this.state.Vie_Level_Start}
                        ></TextInput>
                        ...
                        <View style={{
                            ...
                            <Dropdown
                                ...
                                data={vieLevelUnits}
                                underlineColor='transparent'
                                onChangeText={unit => this.setState({ Vie_Level_Start_Unit: unit, Vie_Level_End_Unit: unit })}
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            ...
                            value={this.state.Tanker_Press_Start}
                        ></TextInput>
                        ...
                        <View style={{
                            ...
                            <Dropdown
                                ...
                                data={pressureUnits}
                                underlineColor='transparent'
                                onChangeText={unit => this.setState({ Tanker_Press_Start_Unit: unit, Tanker_Press_End_Unit: unit })}
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            ...
                            value={this.state.Tanker_Level_Start}
                        ></TextInput>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        ...
                        <View style={{
                            ...
                            <Dropdown
                                ...
                                data={pressureUnits}
                                underlineColor='transparent'
                                onChangeText={unit => this.setState({ Vie_Press_End_Unit: unit, Vie_Press_Start_Unit: unit })}
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            ...
                            value={this.state.Vie_Level_End}
                        ></TextInput>
                        ...
                        <View style={{
                            ...
                            <Dropdown
                                ...
                                data={vieLevelUnits}
                                underlineColor='transparent'
                                onChangeText={unit => this.setState({ Vie_Level_End_Unit: unit, Vie_Level_Start_Unit: unit })}
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            ...
                            value={this.state.Tanker_Press_End}
                        >
                        </TextInput>
                        ...
                        <View style={{
                            ...
                            <Dropdown
                                ...
                                data={pressureUnits}
                                underlineColor='transparent'
                                onChangeText={unit => this.setState({ Tanker_Press_End_Unit: unit, Tanker_Press_Start_Unit: unit })}
                ...
                <View style={styles.twoInputFieldsStyle}>
                    ...
                    <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                        <TextInput
                            ...
                            value={this.state.Tanker_Level_End}
                        ></TextInput>
                    ...
                    <View style={styles.twoInputFieldsStyle}>
                        ...
                        <View style={{ flexDirection: 'row', marginEnd: 5 }}>
                            <TextInput
                                ...
                                value={this.state.Content_Start}
                            ></TextInput>
